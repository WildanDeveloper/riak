//! Initial related-key smoke probe for RIAK v0.3.
//! Run: cargo run --release --example v3_related [cases]
//!
//! This searches for catastrophic one-bit related-key failures; it is not a
//! substitute for a full related-key cryptanalysis.
...
fn main() {
    ...
    println!("RIAK v0.3 related-key smoke probe");
